...
String[] articlesAllSplittedTokened;
...
void draw(){
  ...
  text(articlesAllSplittedTokened[articleNumToScroll], posX*38, 20, 200, 700);
...
void articlesDataParser(){
  ...
  articlesAllSplittedTokened = splitTokens(articlesAllJoined, "\".*");
